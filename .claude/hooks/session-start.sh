...
5. After their answer: generate the tailored CV PDF and display it, show the letter text in chat, and ask « Je la génère en PDF ? (oui / vos modifications) ». On « oui », generate the letter PDF, add "**Cover Letter:** <path>" to the report header, re-run report-html.mjs, display the updated page and the CV again, and send the letter.
